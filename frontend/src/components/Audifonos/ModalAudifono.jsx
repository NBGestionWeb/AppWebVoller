...
const ModalAudifono = ({ isOpen, onClose, onSave, audifonoAEditar }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (onSave) {
            // Enviamos el objeto con la data del formulario y adjuntamos el objeto paciente completo si se seleccionó, 
            // facilitando que la vista principal lo pinte al instante.
            onSave({
                ...formData,
    ...
    return (
        ...
        <div className="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden border border-gray-100 animate-in fade-in zoom-in duration-200">
            ...
            <div className="flex justify-end gap-3 px-6 py-4 bg-gray-50 border-t border-gray-100">
                ...
                <button 
                type="submit" 
                className="px-4 py-2 text-sm font-medium text-white bg-terracota-500 hover:bg-terracota-600 rounded-lg transition-colors cursor-pointer"
                >
